...
router.put('/enderecos/:id', (req, res) => {
    ...
    connection.query(sql, [logradouro, numero, cidade, uf, cep, latitude, longitude, complemento], (error, results, fields) => {
        if (!error) {
            res.send('Dados alterados com sucesso!')
        } else {
            res.send('Erro ao alterar os dados.')
...
router.put('/fornecedores/:id', (req, res) => {
    ...
    connection.query(sql, [razao_social, telefone, cnpj_cpf, tipo_estabelecimento, horario_funcionamento, status_estabelecimento, nome_fantasia, fotos_lugar, descricao], (error, results, fields) => {
        if (!error) {
            res.send('Dados alterados com sucesso!')
        } else {
            res.send('Erro ao alterar os dados.')
...
router.put('/categorias/:id', (req, res) => {
    ...
    connection.query(sql, [nome, foto, descricao], (error, results, fields) => {
        if (!error) {
            res.send('Dados alterados com sucesso!')
        } else {
            res.send('Erro ao alterar os dados.')
...
router.put('/usuarios/:id', (req, res) => {
    ...
    connection.query(sql, [nome, senha, email, email_recuperacao, tipo_conta, foto_usuario, background_perfil, descricao], (error, results, fields) => {
        if (!error) {
            res.send('Dados alterados com sucesso!')
        } else {
            res.send('Erro ao alterar os dados.')
...
router.put('/formaspagamento/:id', (req, res) => {
    ...
    connection.query(sql, [tipo_pagamento, descricao, cpf], (error, results, fields) => {
        if (!error) {
            res.send('Dados alterados com sucesso!')
        } else {
            res.send('Erro ao alterar os dados.')
...
router.put('/pedidos/:id', (req, res) => {
    ...
    connection.query(sql, [data_pedido, status_pedido, descricao], (error, results, fields) => {
        if (!error) {
            res.send('Dados alterados com sucesso!')
        } else {
            res.send('Erro ao alterar os dados.')
...
router.put('/servicos/:id', (req, res) => {
    ...
    connection.query(sql, [nome, valor, qtde_avaliacoes, descricao, duracao, foto], (error, results, fields) => {
        if (!error) {
            res.send('Dados alterados com sucesso!')
        } else {
            res.send('Erro ao alterar os dados.')
...
router.put('/classificacoes/:id', (req, res) => {
    ...
    connection.query(sql, [nota, descricao], (error, results, fields) => {
        if (!error) {
            res.send('Dados alterados com sucesso!')
        } else {
            res.send('Erro ao alterar os dados.')
